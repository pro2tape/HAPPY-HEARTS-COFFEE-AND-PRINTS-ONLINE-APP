...
const Admin: React.FC = () => {
  ...
  const handlePrintMenu = () => {
    // This is a bit of a hack to print only the menu
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <section className="bg-white p-6 rounded-lg shadow-md mb-8 non-printable">
          ...
          <a
            ...
            className="inline-block w-full text-center bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors text-lg"
          >
        ...
        <section className="bg-white p-6 rounded-lg shadow-md mt-8 non-printable">
          <div className="flex justify-between items-center mb-4">
             <h2 className="text-xl font-semibold">Menu Quick View</h2>
             <button onClick={handlePrintMenu} className="bg-gray-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-gray-600 transition-colors">Print Menu</button>
          </div>
